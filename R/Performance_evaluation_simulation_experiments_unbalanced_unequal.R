...
for(j in seq_along(sim_sub_sd)){
  ...
  for(i in seq_along(methods)){
    if(i <= 4){
      load(paste0('simulation-experiments-unbalanced/controlledmixtures-unbalanced-sub_sd=', sim_sub_sd[j], '-by-', methods[i], ".testing-EB.rda"))
      data.res <-data.res$ComparisonResult
    }
    else{
      load(paste0('simulation-experiments-unbalanced/controlledmixtures-unbalanced-sub_sd=', sim_sub_sd[j], '-by-', methods[i], ".testing.rda"))
    }
...
write.csv(all_data_summary, file =  paste0("simulation-experiments-unbalanced/res-unbalanced.csv")) 
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_TPs.pdf",width=3.5,height=3)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_FPs.pdf",width=3.5,height=3)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_FPs_v2.pdf",width=3.5,height=3)
g4 <- all_data_summary %>% ggplot(aes(x=Sub_sd, y= qvalueFPs, group=Method, color = Method, shape = Method, size = Method))+
  geom_line(size=1)+
  geom_point() +
  scale_size_manual(values=c(3, 2, 2, 2, 2))+
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_FDR.pdf",width=3.5,height=3)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_sensitivity.pdf",width=3.5,height=3)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_specificity.pdf",width=3.5,height=3)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_auc.pdf",width=3.5,height=3)
...
save(res1, file = "simulation-experiments-unbalanced/res1.rda")
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_se.pdf",width=11,height=4)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_logfc.pdf",width=11,height=4)
...
pdf("simulation-experiments-unbalanced/Compare_different_sim_vars_DF.pdf",width=11,height=4)
